       ...
       /* public static async Task SendMessage(Message message)
        {
            ...
            var from = new EmailAddress("stanislavlevendeev.web@gmail.com", "Web Site");
            var subject = message.Subject;
            var to = new EmailAddress("slevendeev@gmail.com", "Stanislav Levendeev");
            var plainTextContent = message.Content;
            var htmlContent = $"<strong>{message.Content}</strong>";
